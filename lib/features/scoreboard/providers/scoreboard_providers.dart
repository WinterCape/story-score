...
final sessionProvider =
    StreamProvider.family<GameSession?, String>((ref, sessionId) {
...
final currentStorytellerProvider =
    Provider.family<AsyncValue<Player?>, String>((ref, sessionId) {
...
final sortByScoreProvider = NotifierProvider<_SortNotifier, bool>(_SortNotifier.new);
