...
final roundHistoryProvider =
    StreamProvider.family<List<Round>, String>((ref, sessionId) {
...
final deleteRoundProvider =
    Provider<Future<void> Function({required String roundId, required String sessionId})>((ref) {
  final processor = ref.watch(roundProcessorProvider);
